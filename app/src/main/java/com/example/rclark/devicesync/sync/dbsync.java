...
public class dbsync extends IntentService {
    ...
    private static final String ACTION_FOO = "com.example.rclark.devicesync.sync.action.FOO";
    private static final String ACTION_BAZ = "com.example.rclark.devicesync.sync.action.BAZ";
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, dbsync.class);
